export namespace AST {
  ...
  export interface NodeHandler<T> {
    IdentifierStart?:(node?:Identifier, ref?:T)=>(Node|void)
    IdentifierEnd?:(node?:Identifier, ref?:T)=>(Node|void)
    LiteralStart?:(node?:Literal, ref?:T)=>(Node|void)
    LiteralEnd?:(node?:Literal, ref?:T)=>(Node|void)
    ProgramStart?:(node?:Program, ref?:T)=>(Node|void)
    ProgramEnd?:(node?:Program, ref?:T)=>(Node|void)
    ExpressionStatementStart?:(node?:ExpressionStatement, ref?:T)=>(Node|void)
    ExpressionStatementEnd?:(node?:ExpressionStatement, ref?:T)=>(Node|void)
    BlockStatementStart?:(node?:BlockStatement, ref?:T)=>(Node|void)
    BlockStatementEnd?:(node?:BlockStatement, ref?:T)=>(Node|void)
    EmptyStatementStart?:(node?:EmptyStatement, ref?:T)=>(Node|void)
    EmptyStatementEnd?:(node?:EmptyStatement, ref?:T)=>(Node|void)
    DebuggerStatementStart?:(node?:DebuggerStatement, ref?:T)=>(Node|void)
    DebuggerStatementEnd?:(node?:DebuggerStatement, ref?:T)=>(Node|void)
    WithStatementStart?:(node?:WithStatement, ref?:T)=>(Node|void)
    WithStatementEnd?:(node?:WithStatement, ref?:T)=>(Node|void)
    ReturnStatementStart?:(node?:ReturnStatement, ref?:T)=>(Node|void)
    ReturnStatementEnd?:(node?:ReturnStatement, ref?:T)=>(Node|void)
    LabeledStatementStart?:(node?:LabeledStatement, ref?:T)=>(Node|void)
    LabeledStatementEnd?:(node?:LabeledStatement, ref?:T)=>(Node|void)
    BreakStatementStart?:(node?:BreakStatement, ref?:T)=>(Node|void)
    BreakStatementEnd?:(node?:BreakStatement, ref?:T)=>(Node|void)
    ContinueStatementStart?:(node?:ContinueStatement, ref?:T)=>(Node|void)
    ContinueStatementEnd?:(node?:ContinueStatement, ref?:T)=>(Node|void)
    IfStatementStart?:(node?:IfStatement, ref?:T)=>(Node|void)
    IfStatementEnd?:(node?:IfStatement, ref?:T)=>(Node|void)
    SwitchStatementStart?:(node?:SwitchStatement, ref?:T)=>(Node|void)
    SwitchStatementEnd?:(node?:SwitchStatement, ref?:T)=>(Node|void)
    SwitchCaseStart?:(node?:SwitchCase, ref?:T)=>(Node|void)
    SwitchCaseEnd?:(node?:SwitchCase, ref?:T)=>(Node|void)
    ThrowStatementStart?:(node?:ThrowStatement, ref?:T)=>(Node|void)
    ThrowStatementEnd?:(node?:ThrowStatement, ref?:T)=>(Node|void)
    TryStatementStart?:(node?:TryStatement, ref?:T)=>(Node|void)
    TryStatementEnd?:(node?:TryStatement, ref?:T)=>(Node|void)
    CatchClauseStart?:(node?:CatchClause, ref?:T)=>(Node|void)
    CatchClauseEnd?:(node?:CatchClause, ref?:T)=>(Node|void)
    WhileStatementStart?:(node?:WhileStatement, ref?:T)=>(Node|void)
    WhileStatementEnd?:(node?:WhileStatement, ref?:T)=>(Node|void)
    DoWhileStatementStart?:(node?:DoWhileStatement, ref?:T)=>(Node|void)
    DoWhileStatementEnd?:(node?:DoWhileStatement, ref?:T)=>(Node|void)
    ForStatementStart?:(node?:ForStatement, ref?:T)=>(Node|void)
    ForStatementEnd?:(node?:ForStatement, ref?:T)=>(Node|void)
    ForInStatementStart?:(node?:ForInStatement, ref?:T)=>(Node|void)
    ForInStatementEnd?:(node?:ForInStatement, ref?:T)=>(Node|void)
    FunctionDeclarationStart?:(node?:FunctionDeclaration, ref?:T)=>(Node|void)
    FunctionDeclarationEnd?:(node?:FunctionDeclaration, ref?:T)=>(Node|void)
    VariableDeclarationStart?:(node?:VariableDeclaration, ref?:T)=>(Node|void)
    VariableDeclarationEnd?:(node?:VariableDeclaration, ref?:T)=>(Node|void)
    VariableDeclaratorStart?:(node?:VariableDeclarator, ref?:T)=>(Node|void)
    VariableDeclaratorEnd?:(node?:VariableDeclarator, ref?:T)=>(Node|void)
    ThisExpressionStart?:(node?:ThisExpression, ref?:T)=>(Node|void)
    ThisExpressionEnd?:(node?:ThisExpression, ref?:T)=>(Node|void)
    ArrayExpressionStart?:(node?:ArrayExpression, ref?:T)=>(Node|void)
    ArrayExpressionEnd?:(node?:ArrayExpression, ref?:T)=>(Node|void)
    ObjectExpressionStart?:(node?:ObjectExpression, ref?:T)=>(Node|void)
    ObjectExpressionEnd?:(node?:ObjectExpression, ref?:T)=>(Node|void)
    PropertyStart?:(node?:Property, ref?:T)=>(Node|void)
    PropertyEnd?:(node?:Property, ref?:T)=>(Node|void)
    FunctionExpressionStart?:(node?:FunctionExpression, ref?:T)=>(Node|void)
    FunctionExpressionEnd?:(node?:FunctionExpression, ref?:T)=>(Node|void)
    UnaryExpressionStart?:(node?:UnaryExpression, ref?:T)=>(Node|void)
    UnaryExpressionEnd?:(node?:UnaryExpression, ref?:T)=>(Node|void)
    UpdateExpressionStart?:(node?:UpdateExpression, ref?:T)=>(Node|void)
    UpdateExpressionEnd?:(node?:UpdateExpression, ref?:T)=>(Node|void)
    BinaryExpressionStart?:(node?:BinaryExpression, ref?:T)=>(Node|void)
    BinaryExpressionEnd?:(node?:BinaryExpression, ref?:T)=>(Node|void)
    AssignmentExpressionStart?:(node?:AssignmentExpression, ref?:T)=>(Node|void)
    AssignmentExpressionEnd?:(node?:AssignmentExpression, ref?:T)=>(Node|void)
    LogicalExpressionStart?:(node?:LogicalExpression, ref?:T)=>(Node|void)
    LogicalExpressionEnd?:(node?:LogicalExpression, ref?:T)=>(Node|void)
    MemberExpressionStart?:(node?:MemberExpression, ref?:T)=>(Node|void)
    MemberExpressionEnd?:(node?:MemberExpression, ref?:T)=>(Node|void)
    ConditionalExpressionStart?:(node?:ConditionalExpression, ref?:T)=>(Node|void)
    ConditionalExpressionEnd?:(node?:ConditionalExpression, ref?:T)=>(Node|void)
    CallExpressionStart?:(node?:CallExpression, ref?:T)=>(Node|void)
    CallExpressionEnd?:(node?:CallExpression, ref?:T)=>(Node|void)
    NewExpressionStart?:(node?:NewExpression, ref?:T)=>(Node|void)
    NewExpressionEnd?:(node?:NewExpression, ref?:T)=>(Node|void)
    SequenceExpressionStart?:(node?:SequenceExpression, ref?:T)=>(Node|void)
    SequenceExpressionEnd?:(node?:SequenceExpression, ref?:T)=>(Node|void)
    ForOfStatementStart?:(node?:ForOfStatement, ref?:T)=>(Node|void)
    ForOfStatementEnd?:(node?:ForOfStatement, ref?:T)=>(Node|void)
    SuperStart?:(node?:Super, ref?:T)=>(Node|void)
    SuperEnd?:(node?:Super, ref?:T)=>(Node|void)
    SpreadElementStart?:(node?:SpreadElement, ref?:T)=>(Node|void)
    SpreadElementEnd?:(node?:SpreadElement, ref?:T)=>(Node|void)
    ArrowFunctionExpressionStart?:(node?:ArrowFunctionExpression, ref?:T)=>(Node|void)
    ArrowFunctionExpressionEnd?:(node?:ArrowFunctionExpression, ref?:T)=>(Node|void)
    YieldExpressionStart?:(node?:YieldExpression, ref?:T)=>(Node|void)
    YieldExpressionEnd?:(node?:YieldExpression, ref?:T)=>(Node|void)
    TemplateLiteralStart?:(node?:TemplateLiteral, ref?:T)=>(Node|void)
    TemplateLiteralEnd?:(node?:TemplateLiteral, ref?:T)=>(Node|void)
    TaggedTemplateExpressionStart?:(node?:TaggedTemplateExpression, ref?:T)=>(Node|void)
    TaggedTemplateExpressionEnd?:(node?:TaggedTemplateExpression, ref?:T)=>(Node|void)
    TemplateElementStart?:(node?:TemplateElement, ref?:T)=>(Node|void)
    TemplateElementEnd?:(node?:TemplateElement, ref?:T)=>(Node|void)
    AssignmentPropertyStart?:(node?:AssignmentProperty, ref?:T)=>(Node|void)
    AssignmentPropertyEnd?:(node?:AssignmentProperty, ref?:T)=>(Node|void)
    ObjectPatternStart?:(node?:ObjectPattern, ref?:T)=>(Node|void)
    ObjectPatternEnd?:(node?:ObjectPattern, ref?:T)=>(Node|void)
    ArrayPatternStart?:(node?:ArrayPattern, ref?:T)=>(Node|void)
    ArrayPatternEnd?:(node?:ArrayPattern, ref?:T)=>(Node|void)
    RestElementStart?:(node?:RestElement, ref?:T)=>(Node|void)
    RestElementEnd?:(node?:RestElement, ref?:T)=>(Node|void)
    AssignmentPatternStart?:(node?:AssignmentPattern, ref?:T)=>(Node|void)
    AssignmentPatternEnd?:(node?:AssignmentPattern, ref?:T)=>(Node|void)
    ClassBodyStart?:(node?:ClassBody, ref?:T)=>(Node|void)
    ClassBodyEnd?:(node?:ClassBody, ref?:T)=>(Node|void)
    MethodDefinitionStart?:(node?:MethodDefinition, ref?:T)=>(Node|void)
    MethodDefinitionEnd?:(node?:MethodDefinition, ref?:T)=>(Node|void)
    ClassDeclarationStart?:(node?:ClassDeclaration, ref?:T)=>(Node|void)
    ClassDeclarationEnd?:(node?:ClassDeclaration, ref?:T)=>(Node|void)
    ClassExpressionStart?:(node?:ClassExpression, ref?:T)=>(Node|void)
    ClassExpressionEnd?:(node?:ClassExpression, ref?:T)=>(Node|void)
    MetaPropertyStart?:(node?:MetaProperty, ref?:T)=>(Node|void)
    MetaPropertyEnd?:(node?:MetaProperty, ref?:T)=>(Node|void)
    ImportDeclarationStart?:(node?:ImportDeclaration, ref?:T)=>(Node|void)
    ImportDeclarationEnd?:(node?:ImportDeclaration, ref?:T)=>(Node|void)
    ImportSpecifierStart?:(node?:ImportSpecifier, ref?:T)=>(Node|void)
    ImportSpecifierEnd?:(node?:ImportSpecifier, ref?:T)=>(Node|void)
    ImportDefaultSpecifierStart?:(node?:ImportDefaultSpecifier, ref?:T)=>(Node|void)
    ImportDefaultSpecifierEnd?:(node?:ImportDefaultSpecifier, ref?:T)=>(Node|void)
    ImportNamespaceSpecifierStart?:(node?:ImportNamespaceSpecifier, ref?:T)=>(Node|void)
    ImportNamespaceSpecifierEnd?:(node?:ImportNamespaceSpecifier, ref?:T)=>(Node|void)
    ExportNamedDeclarationStart?:(node?:ExportNamedDeclaration, ref?:T)=>(Node|void)
    ExportNamedDeclarationEnd?:(node?:ExportNamedDeclaration, ref?:T)=>(Node|void)
    ExportSpecifierStart?:(node?:ExportSpecifier, ref?:T)=>(Node|void)
    ExportSpecifierEnd?:(node?:ExportSpecifier, ref?:T)=>(Node|void)
    ExportDefaultDeclarationStart?:(node?:ExportDefaultDeclaration, ref?:T)=>(Node|void)
    ExportDefaultDeclarationEnd?:(node?:ExportDefaultDeclaration, ref?:T)=>(Node|void)
    ExportAllDeclarationStart?:(node?:ExportAllDeclaration, ref?:T)=>(Node|void)
    ExportAllDeclarationEnd?:(node?:ExportAllDeclaration, ref?:T)=>(Node|void)
    FunctionStart?:(node?:BaseFunction, ref?:T)=>(Node|void)
    FunctionEnd?:(node?:BaseFunction, ref?:T)=>(Node|void)
    ForLoopStart?:(node?:ForStatement|ForInStatement|ForOfStatement, ref?:T)=>(Node|void)
