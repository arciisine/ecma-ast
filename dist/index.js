System.register("ast", [], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            (function (AST) {
                ...
                })(AST.UnaryOperator || (AST.UnaryOperator = {}));
                var UnaryOperator = AST.UnaryOperator;
                ...
                var BinaryOperator = AST.BinaryOperator;
                (function (LogicalOperator) {
                    LogicalOperator[LogicalOperator[",,"] = 0] = ",,";
                    LogicalOperator[LogicalOperator["&&"] = 1] = "&&";
                })(AST.LogicalOperator || (AST.LogicalOperator = {}));
                var LogicalOperator = AST.LogicalOperator;
                ...
                })(AST.AssignmentOperator || (AST.AssignmentOperator = {}));
                var AssignmentOperator = AST.AssignmentOperator;
                (function (UpdateOperator) {
                    UpdateOperator[UpdateOperator["++"] = 0] = "++";
                    UpdateOperator[UpdateOperator["--"] = 1] = "--";
                })(AST.UpdateOperator || (AST.UpdateOperator = {}));
                var UpdateOperator = AST.UpdateOperator;
            })(AST = AST || (AST = {}));
            exports_1("AST", AST);
        }
    }
});
System.register("escodegen/lib", [], function(exports_2, context_2) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            out = (function (global) {
                let require = function (file, parentModule) {
                ...
                require.define('/escodegen.js', function (module, exports, __dirname, __filename) {
                    (function () {
                        ...
                        let CodeGenerator = function CodeGenerator() {
                        };
                ...
                require.define('/node_modules/source-map/lib/source-map/source-node.js', function (module, exports, __dirname, __filename) {
                    ...
                    define(function (require, exports, module) {
                        ...
                        let SourceNode = function SourceNode(aLine, aColumn, aSource, aChunks, aName) {
                            this.children = [];
                            this.sourceContents = {};
                ...
                require.define('/node_modules/amdefine/amdefine.js', function (module, exports, __dirname, __filename) {
                    ...
                    function amdefine(module, requireFn) {
                        ...
                        makeRequire = function (systemRequire, exports, module, relId) {
                            let amdRequire = function amdRequire(deps, callback) {
                ...
                require.define('/node_modules/source-map/lib/source-map/source-map-generator.js', function (module, exports, __dirname, __filename) {
                    ...
                    define(function (require, exports, module) {
                        ...
                        let SourceMapGenerator = function SourceMapGenerator(aArgs) {
                            if (!aArgs) {
                                aArgs = {};
                            }
                ...
                require.define('/node_modules/source-map/lib/source-map/array-set.js', function (module, exports, __dirname, __filename) {
                    ...
                    define(function (require, exports, module) {
                        var util = require('/node_modules/source-map/lib/source-map/util.js', module);
                        let ArraySet = function ArraySet() {
                            this._array = [];
                            this._set = {};
                        };
                ...
                require.define('/node_modules/source-map/lib/source-map/source-map-consumer.js', function (module, exports, __dirname, __filename) {
                    ...
                    define(function (require, exports, module) {
                        var util = require('/node_modules/source-map/lib/source-map/util.js', module);
                        let SourceMapConsumer = function SourceMapConsumer(aSourceMap) {
                ...
                require.define('/node_modules/source-map/lib/source-map/basic-source-map-consumer.js', function (module, exports, __dirname, __filename) {
                    ...
                    define(function (require, exports, module) {
                        ...
                        let BasicSourceMapConsumer = function BasicSourceMapConsumer(aSourceMap) {
                            var sourceMap = aSourceMap;
                            if (typeof aSourceMap === 'string') {
                                sourceMap = JSON.parse(aSourceMap.replace(/^\)\]\}'/, ''));
                            }
                ...
                require.define('/node_modules/estraverse/estraverse.js', function (module, exports, __dirname, __filename) {
                    (function (root, factory) {
                        ...
                        function ignoreJSHintError(...args) {
                        }
                        isArray = Array.isArray;
                        if (!isArray) {
                            isArray = function isArray(array) {
            ...
            exports_2("default",this.escodegen);
        }
    }
});
System.register("escodegen/index", ["escodegen/lib"], function(exports_3, context_3) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            exports_3("generate", generate = lib_1.default['generate']);
        }
    }
});
System.register("macro", [], function(exports_4, context_4) {
    "use strict";
    ...
    return {
        setters:[],
        execute: function() {
            id_ = new Date().getTime() % 10000;
            Macro = class Macro {
                static genSymbol() {
                    return "__gen" + parseInt(`${Math.random() * 1000}`) + (id_++);
                }
            };
            Macro.Id = (name) => ({ type: "Identifier", name: name || Macro.genSymbol() });
            Macro.Literal = (value) => ({ type: "Literal", value });
            Macro.Block = (...body) => ({ type: "BlockStatement", body: body.filter(x => !!x) });
            Macro.Expr = (n) => ({ type: "ExpressionStatement", expression: n });
            Macro.Continue = (label) => ({ type: "ContinueStatement", label });
            Macro.Noop = () => Macro.Block([]);
            Macro.Return = (e) => ({ type: "ReturnStatement", argument: e });
            Macro.Yield = (e, delegate = false) => {
                return { type: "YieldExpression", argument: e, delegate };
            };
            Macro.Array = (size = 0) => {
                return {
                    type: "ArrayPattern",
            ...
            Macro.Throw = (e) => { return { type: "ThrowStatement", argument: e }; };
            Macro.Call = (src, ...args) => {
                return { type: "CallExpression", callee: src, arguments: args.filter(x => !!x) };
            };
            Macro.Assign = (id, expr, op = '=') => {
                return {
            ...
            Macro.Increment = (id, increment = 1) => {
                return Macro.Assign(id, Macro.Literal(increment), '+=');
            };
            Macro.Labeled = (id, body) => {
                return {
            ...
            Macro.ForLoop = (id, init, upto, body, increment = 1) => {
                return {
                    type: "ForStatement",
            ...
            Macro.Func = (id, params, body, generator = false) => {
                return {
            ...
            Macro.IfThen = (test, body, elseBody = []) => {
                let res = {
                    type: "IfStatement",
                    test,
            ...
            exports_4("Macro", Macro);
        }
    }
});
/// <reference path="../node_modules/@types/lodash/index.d.ts" />
/// <reference path="../node_modules/@types/esprima/index.d.ts" />
System.register("transform", ["lodash", "esprima", "escodegen/index", "macro"], function(exports_5, context_5) {
    "use strict";
    var __moduleName = context_5 && context_5.id;
    var _, esprima, escodegen, macro_1;
    var Transform;
    return {
        setters:[
            function (_1) {
            ...
            function (escodegen_1) {
                escodegen = escodegen_1;
            },
            function (macro_1_1) {
                macro_1 = macro_1_1;
            }],
        execute: function() {
            Transform = class Transform {
                ...
                static parse(fn) {
                    let ast = esprima.parse(fn.toString()).body[0];
                    return ast;
                }
                static compile(node, globals) {
                    let genSym = macro_1.Macro.genSymbol.toString();
                    let src = `(function() {     
      ...
      return ${escodegen.generate(node)}; 
            ...
            exports_5("Transform", Transform);
        }
    }
});
System.register("index", ["transform", "ast", "macro"], function(exports_6, context_6) {
    "use strict";
    ...
    return {
        setters:[
            function (transform_1_1) {
                exportStar_1(transform_1_1);
            },
            function (ast_1_1) {
                exportStar_1(ast_1_1);
            },
            function (macro_2_1) {
                exportStar_1(macro_2_1);
            }],
        execute: function() {
        }
    }
